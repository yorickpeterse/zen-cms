...
describe('Ramaze::Helper::Section') do
  ...
  should('validate a valid section') do
  ...
  should('validate an invalid section') do
  ...
  should('validate a valid section entry') do
  ...
  should('validate an invalid section entry') do
