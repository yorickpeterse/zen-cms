...
describe('CustomFields::Controller::CustomFields') do
  ...
  should('find no existing fields') do
  ...
  should('search for a custom field') do
  ...
  should("edit an existing custom field") do
  ...
  should("edit an existing custom field with invalid data") do
    visit(index_url)
    click_link('Spec field')
  ...
  should('fail to delete a field without an ID') do
    message = lang('custom_fields.messages.no_fields')
  ...
  should("delete an existing custom field") do
    message = lang('custom_fields.messages.no_fields')
  ...
  should('call the event new_custom_field (before and after)') do
    event_name  = nil
    type_select = lang('custom_fields.special.type_hash.textarea')
  ...
  should('call the event edit_custom_field (before and after)') do
    event_name = nil
  ...
  should('call the event delete_custom_field (before and after)') do
    event_name  = nil
    event_name2 = nil
