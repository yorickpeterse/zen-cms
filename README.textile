...
Currently you'll need to build both Rack, Ramaze and possibily Innate manually as Zen
uses various new features of these Gems that were recently introduced. This will no longer
be required once a new version of Rack/Ramaze is released.
...
bc. $ git clone git://github.com/RubyZen/zen-core.git
$ cd zen-core
