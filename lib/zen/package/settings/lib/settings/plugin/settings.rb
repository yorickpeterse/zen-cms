...
module Settings
  ...
  module Plugin
    ##
    # The settings plugin is a plugin that can be used to register and migrate settings
    # without having to manually insert the data. Previously you'd have to manually insert
    # the data into the settings table at some point and the process of loading 
    # translation keys and possible values was a pain. This this plugin was created to
    # solve most of those problems.
    #
    # ## Adding Settings
    #
    # In order to add a setting you'll first need to ensure there's at least a single
    # setting group available. These groups don't add any extra features or whatsoever but
    ...
    #     end
    # 
    # When registering a group you only need to specify a title and a name. The name is
    # used to associate a setting with it's group and thus should always be unique. The
    # title is displayed in the tab for the specific settings group.
    # 
    ...
    #     end
    #
    # Note that the values array (or hash) is used to determine the possible values for
    # a field. These values will only be used for elements that only allow a user to 
    # choose a single value (e.g. a checkbox). For the type getter/setter you can use
    ...
    # ## Migrating Settings
    #
    # Once a setting has been added you still have to migrate it. Zen takes care of this
    ...
    class Settings
      ...
      # variables so they can be used by Settings::Plugin::Settings.call.
      #
      # @author Yorick Peterse
      # @since  0.2.5
      ...
      ##
      # Inserts all settings into the database. This method will ignore the settings that
      # have already been inserted into the database.
      #
      # @author Yorick Peterse
      # @since  0.2.5
      #
      ...
      ##
      # Removes the settings who's names match those specified in the array. The values
      # of these settings will also be removed from the database.
      #
      # @author Yorick Peterse
      # @since  0.2.5
