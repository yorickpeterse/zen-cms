Zen::Language::Translation.add do |trans|
  ...
  trans.translate do |t|
    ...
    t['includes']     = 'De waarde van dit veld is niet binnen het bereik '\
      'van %s.'
    t['integer']      = 'De waarde van dit veld is niet numeriek.'
    t['length_range'] = 'De waarde van dit veld is te lang of te kort.'
    t['max_length']   = 'De waarde van dit veld mag niet langer zijn dan ' \
      '%s karakters.'
    t['min_length']   = 'De waarde van dit veld mag niet korter zijn dan ' \
      '%s karakters.'
