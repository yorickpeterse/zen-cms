...
Zen.Editor = new Class(
{
    ...
    [
        {
            name:    'bold',
            label:   lang('zen_general.buttons.bold'),
            onClick: 'bold'
        },
        {
            name:    'italic',
            label:   lang('zen_general.buttons.italic'),
            onClick: 'italic'
        },
        {
            name:   'link',
            label:   lang('zen_general.buttons.link'),
            onClick: 'link'
        },
        {
            name:   'ul',
            label:   lang('zen_general.buttons.ul'),
            onClick: 'ul'
        },
        {
            name:    'ol',
            label:   lang('zen_general.buttons.ol'),
            onClick: 'ol'
        },
        {
            name:    'preview',
            label:   lang('zen_general.buttons.preview'),
            onClick: 'preview'
        }
    ],
    ...
    preview: function(editor)
    {
        ...
        new Request(
        {
            ...
            onSuccess: function(response)
            {
                ...
                {
                    title: lang('zen_general.buttons.preview'),
                    width: 700
                });
            }
        }).send();
