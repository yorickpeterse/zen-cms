...
Zen.Editor = new Class(
{
    ...
    [
        {
            name:    'bold',
            label:   Zen.translations['zen_general.buttons.bold'],
            onClick: 'bold'
        },
        {
            name:    'italic',
            label:   Zen.translations['zen_general.buttons.italic'],
            onClick: 'italic'
        },
        {
            name:   'link',
            label:   Zen.translations['zen_general.buttons.link'],
            onClick: 'link'
        },
        {
            name:   'ul',
            label:   Zen.translations['zen_general.buttons.ul'],
            onClick: 'ul'
        },
        {
            name:    'ol',
            label:   Zen.translations['zen_general.buttons.ol'],
            onClick: 'ol'
        },
        {
            name:    'preview',
            label:   Zen.translations['zen_general.buttons.preview'],
            onClick: 'preview'
        }
    ],
        ...
        this.buttons.each(function(button)
        {
            var btn = new Element(
                'button',
                {
                    ...
                    html:    '<span class="button_icon"></span>' + button.label,
                    title:   button.label
                }
            );
    ...
    preview: function(editor)
    {
        ...
        new Request(
        {
            ...
            {
                new Zen.Window(response,
                {
                    title: Zen.translations['zen_general.buttons.preview'],
                    width: 700
                });
            }
        }).send();
