...
Zen.Editor = new Class(
{
    ...
    Depends:
    {
        ...
        javascript:
        [
            'zen/editor/drivers/markdown', 'zen/editor/drivers/textile', 'zen/window'
        ]
    },
...
Zen.Editor.init = function(driver, element, options)
{
    ...
    {
        instance = new Zen.Editor(element, options);
    }
    else
    {
        instance = new Zen.Editor[driver_class](element, options);
    }
