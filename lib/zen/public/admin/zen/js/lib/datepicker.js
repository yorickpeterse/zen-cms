...
Locale.define('en-US', 'DatePicker', {
    select_a_time:       lang('zen_general.datepicker.select_a_time'),
	use_mouse_wheel:     lang('zen_general.datepicker.use_mouse_wheel'),
	time_confirm_button: lang('zen_general.datepicker.time_confirm_button'),
	apply_range:         lang('zen_general.datepicker.apply_range'),
	cancel:              lang('zen_general.datepicker.cancel'),
	week:                lang('zen_general.datepicker.week')
});
...
this.DatePicker = Picker.Date = new Class({
	...
	getInputDate: function(input){
        ...
        // Taken from <https://github.com/brenard/mootools-datepicker/commit/
        // e8f93156cf8ed989a31c9c8d5e75b1bdb294afb2>
