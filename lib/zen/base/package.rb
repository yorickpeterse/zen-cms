...
module Zen
  ...
  # directory is used for CSS files, images and so on. It's also important to remember that
  # you can't just download and install a theme somebody else made. Themes heavily rely
  # on custom fields from the database and if those fields don't exist it's almost guaranteed
  # that the theme you just installed won't work. At the time of writing (February 2011)
  # I'm thinking of a system to automatically insert/delete custom fields and sections
  # but there's no guarantee that this will be added as it's pretty complicated to implement.
  #
